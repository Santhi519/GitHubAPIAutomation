...
//    	JSONArray jsonSchemaexpected=new JSONArray(new JSONTokener(Objects.requireNonNull(JsonSchemaValidate.class.getResourceAsStream("/ExpectedJsonSchema" + File.separator + schemaFile))));
    	JSONArray jsonSubjectActual=new JSONArray(new JSONObject(actualResponse)); 
